...
const ROW_DEFS: RowDef[] = [
  ...
  { key: 'score_alto', type: 'number', group: 'score', label: 'Score quando há vício forte', description: '0-100. Aparece como "Boa chance" no front.' },
  { key: 'score_moderado', type: 'number', group: 'score', label: 'Score quando não há vício forte', description: '0-100. Aparece como "Vale tentar" no front.' },
  { key: 'msg_score_alto', type: 'text', group: 'mensagens', label: 'Mensagem — score alto', description: 'Exibida quando há vício forte.', rows: 3 },
  { key: 'msg_score_moderado', type: 'text', group: 'mensagens', label: 'Mensagem — score moderado', description: 'Exibida quando não há vício forte.', rows: 4 },
